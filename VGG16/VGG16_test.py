...
test_dataset = torchvision.datasets.ImageFolder(root='D:/PyCharm 2020.2/PycharmProjects/flower/new_data/test/', transform=data_transform)
...
check = torch.load("VGG16_flower_200.pkl",map_location='cpu')
