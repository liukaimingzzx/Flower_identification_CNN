...
#获取数据集
#训练集
train_dataset = ImageFolder(root='D:/PyCharm 2020.2/PycharmProjects/flower/new_data/train/',transform=data_transform)
train_loader = DataLoader(train_dataset, batch_size = batch_size, shuffle=True)
#验证集
val_dataset = ImageFolder(root='D:/PyCharm 2020.2/PycharmProjects/flower/new_data/val/', transform=data_transform)
...
#保存模型参数
torch.save(net.state_dict(), 'alexnet_final.pkl')
